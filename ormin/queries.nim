...
macro protocol*(name: static[string], wsurl: static[string] = ""; body: untyped): untyped =
  ...
  if wsurl != "":
    clientBody.add ident"import karax / [kajax, jwebsockets, jjson]"
    clientBody.add ident("""
let conn = newWebSocket(""""&wsurl&"""", "ormin")
